...
public class ss3Panel extends javax.swing.JPanel {
    ...
    public ss3Panel() {
     ...
     private void fetchRecord(){
        try{
            ...
            String query = "SELECT FIRST_NAME,MIDDLE_NAME,LAST_NAME from STUDENT_DETAILS WHERE CLASS_ID = 6";
            pst = con.prepareStatement(query);//prepares the sql statement
            rs = pst.executeQuery();//executes the sql statement
            table2.setModel(DbUtils.resultSetToTableModel(rs));      
        }catch(Exception ex){
            JOptionPane.showMessageDialog(ss3Panel.this, ex);
        }finally{
            try{
                rs.close();
                pst.close();
