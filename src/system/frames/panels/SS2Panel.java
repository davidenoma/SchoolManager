...
public class SS2Panel extends javax.swing.JPanel {
    ...
    public SS2Panel() {
     ...
     private void fetchRecord(){
        try{
            ...
            String query = "SELECT FIRST_NAME,MIDDLE_NAME,LAST_NAME from STUDENT_DETAILS WHERE CLASS_ID = 5";
            pst = con.prepareStatement(query);//prepares the sql statement
            rs = pst.executeQuery();//executes the sql statement
            table2.setModel(DbUtils.resultSetToTableModel(rs));      
        }catch(Exception ex){
            JOptionPane.showMessageDialog(SS2Panel.this, ex);
        }finally{
            try{
                rs.close();
                pst.close();
